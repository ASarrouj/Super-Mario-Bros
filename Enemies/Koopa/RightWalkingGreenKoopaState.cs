...
{
    class RightWalkingGreenKoopaState : KoopaState, IEnemyState
    {
        private AnimatedSprite sprite;

        public RightWalkingGreenKoopaState(Koopa koopa) : base(koopa, new Point(0x10, 0x18))
        {
            this.sprite = EnemySpriteFactory.Instance.CreateRightWalkingGreenKoopa();
