...
{
    class RightMovingRedKoopaShellState : KoopaState, IEnemyState
    {
        private StaticSprite sprite;

        public RightMovingRedKoopaShellState(Koopa koopa) : base (koopa, new Point(0x10, 0xE))
        {
        ...
        {
            koopa.State = new LeftMovingRedKoopaShellState(koopa);
        }
