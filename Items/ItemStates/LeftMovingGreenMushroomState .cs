...
{
    class LeftMovingGreenMushroomState : IItemState
    {
        ...
        public LeftMovingGreenMushroomState(Item mushroom)
        {
        ...
        {
            mushroom.State = new RightMovingGreenMushroomState(mushroom);
        }
