...
{
    class RightSprintingRedLinkState : IRedLinkState
    {
        ...
        public RightSprintingRedLinkState(Link link)
        {
            collisionSize = new Point(16, 32);
            this.link = link;
            game = link.game;
            sprite = RedLinkSpriteFactory.Instance.CreateRightSprintingRedLink();
        }
