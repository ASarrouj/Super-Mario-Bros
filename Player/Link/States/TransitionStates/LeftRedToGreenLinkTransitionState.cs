...
{
    public class LeftRedToGreenLinkTransitionState : IPlayerState
    {
        ...
        public LeftRedToGreenLinkTransitionState(Link link)
        {
            collisionSize = new Point(16, 29);
            currentFrame = 0;
            this.link = link;
            sprite = LinkTransitionSpriteFactory.Instance.CreateLeftRedToGreenLink();
