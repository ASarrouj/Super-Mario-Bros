...
{
    class RightStabbingGreenLinkState : IGreenLinkState
    {
        ...
        public RightStabbingGreenLinkState(Link link)
        {
            ...
            game = link.game;
            currentFrame = 0;
            sprite = GreenLinkSpriteFactory.Instance.CreateRightStabbingGreenLink();
        }
