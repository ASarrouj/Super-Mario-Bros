...
{
    class LeftStabbingGreenLinkState : IGreenLinkState
    {
        ...
        public LeftStabbingGreenLinkState(Link link)
        {
            ...
            game = link.game;
            currentFrame = 0;
            sprite = GreenLinkSpriteFactory.Instance.CreateLeftStabbingGreenLink();
        }
