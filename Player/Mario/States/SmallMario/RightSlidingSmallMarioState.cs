...
{
    class RightSlidingSmallMarioState : ISmallMarioState
    {
        ...
        public RightSlidingSmallMarioState(Mario mario)
        {
            collisionSize = new Point(14, 16);
            this.mario = mario;
            game = mario.game;
            sprite = SmallMarioSpriteFactory.Instance.CreateRightSlidingSmallMario();
        }
