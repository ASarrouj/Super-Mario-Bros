...
{
    class RightShootingFireMarioState : IFireMarioState
    {
        ...
        public RightShootingFireMarioState(Mario mario)
        {
            collisionSize = new Point(16, 32);
            currentFrame = 0;
            this.mario = mario;
            game = mario.game;
            sprite = FireMarioSpriteFactory.Instance.CreateRightShootingFireMario();
        }
