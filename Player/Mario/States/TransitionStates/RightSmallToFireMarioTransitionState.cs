...
{
    public class RightSmallToFireMarioTransitionState : IPlayerState
    {
        ...
        public RightSmallToFireMarioTransitionState(Mario mario)
        {
            ...
            sprite = MarioTransitionSpriteFactory.Instance.CreateRightSmallToFireMario();
