...
{
    public class LeftFireToSmallMarioTransitionState : IPlayerState
    {
        ...
        public LeftFireToSmallMarioTransitionState(Mario mario)
        {
            ...
            sprite = MarioTransitionSpriteFactory.Instance.CreateLeftFireToSmallMario();
        }
