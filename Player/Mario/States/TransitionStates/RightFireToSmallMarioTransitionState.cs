...
{
    public class RightFireToSmallMarioTransitionState : IPlayerState
    {
        ...
        public RightFireToSmallMarioTransitionState(Mario mario)
        {
            ...
            sprite = MarioTransitionSpriteFactory.Instance.CreateRightFireToSmallMario();
        }
