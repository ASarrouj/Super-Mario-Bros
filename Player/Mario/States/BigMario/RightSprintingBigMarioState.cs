...
{
    class RightSprintingBigMarioState : IBigMarioState
    {
        ...
        public RightSprintingBigMarioState(Mario mario)
        {
            collisionSize = new Point(16, 32);
            this.mario = mario;
            game = mario.game;
            sprite = BigMarioSpriteFactory.Instance.CreateRightSprintingBigMario();
        }
