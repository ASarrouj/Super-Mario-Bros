...
{
    class RightSlidingBigMarioState : IBigMarioState
    {
        ...
        public RightSlidingBigMarioState(Mario mario)
        {
            collisionSize = new Point(16, 32);
            this.mario = mario;
            game = mario.game;
            sprite = BigMarioSpriteFactory.Instance.CreateRightSlidingBigMario();
        }
