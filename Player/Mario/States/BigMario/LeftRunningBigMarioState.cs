...
{
    class LeftRunningBigMarioState : IBigMarioState
    {
        ...
        public LeftRunningBigMarioState(Mario mario)
        {
            ...
            this.mario = mario;
            game = mario.game;
            sprite = BigMarioSpriteFactory.Instance.CreateLeftRunningBigMario();
        }
        ...
        public void TransitionLeft()
        {
            ...
            if (mario.Velocity.X < -130.0f)
                mario.state = new LeftSprintingBigMarioState(mario);
        }
